...
class ViewExpression(object):
    ...
    def set_field(self, field, value_or_expr):
        ...
        elif isinstance(value_or_expr, Model):
            value = value_or_expr.dict()
            value.pop("_id", None)
        else:
            value = value_or_expr
    ...
    def substr(self, start: int = None, end: int = None, count: int = None):
    ...
    def split(self, delimiter, maxsplit: int = None):
    ...
    def rsplit(self, delimiter, maxsplit: int = None):
        """Splits this expression, which must resolve to a string, by the given
        delimiter.
