...
class Config:
    ...
    SIGNED_GET_THUMBNAIL_URL_EXPIRATION = os.environ.get('SIGNED_GET_THUMBNAIL_URL_EXPIRATION ', 100)
    SIGNED_GET_IMAGE_URL_EXPIRATION = os.environ.get('SIGNED_GET_IMAGE_URL_EXPIRATION ', 100)
